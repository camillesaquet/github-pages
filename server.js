...
const STORAGE_ROOT = process.env.AGRI_DATA_DIR || path.join(os.homedir(), '.agri-holann');
const DB_PATH = path.join(STORAGE_ROOT, 'db', 'agriholann.db');
const ATTACHMENTS_DIR = path.join(STORAGE_ROOT, 'attachments');
...
async function initDatabase() {
  await ensureDirectoryExists(STORAGE_ROOT);
...
module.exports = { initDatabase, paths: { STORAGE_ROOT, DB_PATH, ATTACHMENTS_DIR } };
