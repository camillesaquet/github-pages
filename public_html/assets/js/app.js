...
function renderArchivedCourses() {
  ...
  state.archivedCourses
    ...
    .forEach((course) => {
      ...
      row.innerHTML = `
        <td class="px-4 py-3 whitespace-nowrap" data-label="Date">${course.date.toLocaleDateString('fr-FR')}</td>
        <td class="px-4 py-3 whitespace-nowrap" data-label="Chauffeur">${course.driverName || ''}</td>
        ...
        <td class="px-4 py-3 whitespace-nowrap" data-label="Marchandise">${course.merchandise || '—'}</td>
        <td class="px-4 py-3 text-sm text-gray-500" data-label="Commentaires">${course.comments || ''}</td>
        <td class="px-4 py-3 whitespace-nowrap actions-cell" data-label="Actions">
...
function renderWeekCourses() {
  ...
  state.driverCourses
    ...
    .forEach((course) => {
      ...
      row.innerHTML = `
        <td class="px-6 py-4 whitespace-nowrap" data-label="Date">${formatDate(course.date)}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Départ">${course.departure}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Arrivée">${course.destination}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Horaire">${formatTime(course.date)}</td>
...
function renderAdminCourses() {
  ...
  state.adminCourses
    ...
    .forEach((course) => {
      ...
      row.innerHTML = `
        <td class="px-6 py-4 whitespace-nowrap" data-label="Chauffeur">${course.driverName || ''}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Date">${formatDate(course.date)}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Départ">${course.departure}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Arrivée">${course.destination}</td>
        <td class="px-6 py-4 whitespace-nowrap" data-label="Horaire">${formatTime(course.date)}</td>
        ...
        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium actions-cell" data-label="Actions">
